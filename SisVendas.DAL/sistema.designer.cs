...
namespace SisVendas.DAL
{
    ...
    partial void DeleteProduto(Produto instance);
		...
		public sistemaDataContext() : 
				base(global::SisVendas.DAL.Properties.Settings.Default.db_sistemaConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void Ondesc_categoriaChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tb_categoria_tb_produto", Storage="_Produtos", ThisKey="id_categoria", OtherKey="id_categoria")]
